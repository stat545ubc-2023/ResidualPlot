...
The goal of ResidualPlot is to make a residual plot for a simple linear model. It contains the function *residual_plot* which 
makes a residual plot for the data given.

## Installation

You can install the development version of ResidualPlot from [Github](https://github.com/) with:
